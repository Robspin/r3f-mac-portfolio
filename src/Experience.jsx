...
const Scene = () => {
    ...
    return <>
        ...
        <PresentationControls global rotation={[0.13, 0.1, 0]} polar={[-0.4, 0.2]} azimuth={[-1, 0.75]} config={{ mass: 2, tension: 400 }} snap={{ mass: 4, tension: 400 }}>
            <Float rotationIntesity={0.4}>
                <rectAreaLight width={2.5} height={1.65} intensity={65} color={'#ff6bf7'} rotation={[0.1, Math.PI, 0]} position={[0, 0.55, -1.15]} />
                <primitive object={scene} position-y={-1.2} >
                    <Html transform wrapperClass="htmlScreen" distanceFactor={1.17} position={[0, 1.56, -1.4]} rotation-x={-0.256}>
                        <iframe src="https://robinsteeman.com"  />
                    </Html>
                </primitive>
                <Text font="./bangers-v20-latin-regular.woff" fontSize={1} position={[2, 0.75, 0.75]} rotation-y={-1.25} maxWidth={2} textAlign="center">ROBIN STEEMAN</Text>
            </Float>
